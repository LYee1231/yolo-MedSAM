...
parser.add_argument(
    ...
    "--data_path",
    type=str,
    default="D:/nnUNet/nnUNet_raw/Dataset101_fetalhead/imagesTr/",
...
for fname in os.listdir(args.data_path):
    if not fname.lower().endswith(".png"):
        continue
    img_path=join(args.data_path,fname)
...
# %% image preprocessing
    ...
    box_np = np.array([[int(0.15*W),int(0.15*H),int(0.85*W),int(0.85*H)]])
...
# transfer box_np t0 1024x1024 scale
    ...
    io.imsave(
        join("D:/nnUNet/nnUNet_raw/Dataset101_fetalhead/sam_output", "seg_" + fname),
        medsam_seg,
